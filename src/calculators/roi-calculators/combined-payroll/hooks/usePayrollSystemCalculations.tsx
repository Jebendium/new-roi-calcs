...
const usePayrollSystemCalculations = (inputs: CombinedPayrollInputs): PayrollSystemResults => {
  ...
  return useMemo((): PayrollSystemResults => {
    ...
    const yearEndHoursSaved =
      inputs.yearEndHours *
      (inputs.yearEndTimeReduction / 100);
    ...
    const totalHoursSaved = processingHoursSaved + yearEndHoursSaved + queryHoursSaved;
